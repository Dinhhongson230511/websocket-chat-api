...
return [
    ...
    */
    ...
    'before_today' => ':attributeには今日以前の日付を指定してください。',
    ...
    'max_characters' => ':attributeは:max文字以内で入力してください。',
    ...
    */
    ...
    'invalid_max_file' => 'ファイルが大きすぎます。10MB以下のファイルをアップロードしてください。',
    'invalid_type_file' => '有効なファイルをアップロードしてください',
    'checkbox_required' => ':attributeが1つ以上は必ず入力してください。',
    'select_required' => ':attributeを選択してください',
    'attributes' => [],
    'change_password' => [
        'invalid' => 'パスワードは数字、英大文字、英小文字、記号のうち３種類を使用し８桁以上で設定して下さい',
        'confirm' => '入力されたパスワードが確認パスワードと一致しません。もう一度入力してください。'
    ],
    'regex_number' => ':attributeの形式が不正です。',
    'regex_furigana' => 'カタカナで入力してください。',
    'invalid_hours' => '終了時間は開始よりも後でなければなりません。',
    'invalid_size_file' => ':attributeは1000KB以下のファイルを指定してください。',
    'custom_numeric' => [
        'min' => ':attributeは:min文字以上で入力してください。'
    ],
    'agency_exist' => "団体は既に存在しています。",
    'seats_total_people' => "すべてのテーブルの総人数は、お客様の人数よりも少なくなければなりません。",
];
